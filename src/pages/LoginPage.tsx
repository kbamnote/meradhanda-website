...
// Login happens in the CRM app. The marketing site hands the visitor off to it.
  ...
  return (
    <div className="min-h-screen pt-24 pb-20 bg-[#FBF6F1] flex items-center justify-center px-6">
      <div className="text-center">
        ...
        <p className="text-gray-500 font-semibold">Taking you to sign in…</p>
        <a href={`${APP_URL}/login`} className="text-[#C05621] font-bold underline mt-2 inline-block">
